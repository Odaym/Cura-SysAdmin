...
public class Server_Home_Activity extends TabActivity implements OnClickListener,
        OnTouchListener {
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            conn = null;
            Toast.makeText(Server_Home_Activity.this, R.string.serviceDisconnected,
    ...
    protected void onDestroy() {
        super.onDestroy();
        stopService(new Intent(Server_Home_Activity.this, ConnectionService.class));
